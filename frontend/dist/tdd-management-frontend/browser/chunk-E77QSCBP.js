...
function RolesComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RolesComponent_div_17_Template_div_click_0_listener() {
...
function RolesComponent_div_19_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function RolesComponent_div_19_div_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 44)(1, "p-button", 45);
    \u0275\u0275listener("click", function RolesComponent_div_19_div_8_Template_p_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.cancelChanges());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "p-button", 46);
    \u0275\u0275listener("click", function RolesComponent_div_19_div_8_Template_p_button_click_2_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function RolesComponent_div_19_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function RolesComponent_div_19_th_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th", 49)(1, "div", 50);
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "p-checkbox", 51);
    \u0275\u0275listener("ngModelChange", function RolesComponent_div_19_th_15_Template_p_checkbox_ngModelChange_3_listener($event) {
...
function RolesComponent_div_19_tr_17_td_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 55)(1, "p-checkbox", 51);
    \u0275\u0275twoWayListener("ngModelChange", function RolesComponent_div_19_tr_17_td_3_Template_p_checkbox_ngModelChange_1_listener($event) {
    ...
    \u0275\u0275listener("ngModelChange", function RolesComponent_div_19_tr_17_td_3_Template_p_checkbox_ngModelChange_1_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function RolesComponent_div_19_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 52)(1, "td", 53);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, RolesComponent_div_19_tr_17_td_3_Template, 2, 2, "td", 54);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RolesComponent_div_19_div_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 56)(1, "p-button", 45);
    \u0275\u0275listener("click", function RolesComponent_div_19_div_18_Template_p_button_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.cancelChanges());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "p-button", 46);
    \u0275\u0275listener("click", function RolesComponent_div_19_div_18_Template_p_button_click_2_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.savePermissions());
    });
...
function RolesComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, RolesComponent_div_19_span_7_Template, 2, 0, "span", 34);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, RolesComponent_div_19_div_8_Template, 3, 2, "div", 35)(9, RolesComponent_div_19_div_9_Template, 3, 0, "div", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "table", 37)(11, "thead")(12, "tr", 38)(13, "th", 39);
    \u0275\u0275text(14, "Module");
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, RolesComponent_div_19_th_15_Template, 4, 3, "th", 40);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "tbody");
    \u0275\u0275template(17, RolesComponent_div_19_tr_17_Template, 4, 4, "tr", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, RolesComponent_div_19_div_18_Template, 3, 2, "div", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function RolesComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
...
function RolesComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 60)(1, "span", 61);
    \u0275\u0275text(2, "Add Role");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 44)(4, "p-button", 45);
    \u0275\u0275listener("click", function RolesComponent_ng_template_22_Template_p_button_click_4_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showForm = false);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p-button", 62);
    \u0275\u0275listener("click", function RolesComponent_ng_template_22_Template_p_button_click_5_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
...
function RolesComponent_small_28_Template(rf, ctx) {
  if (rf & 1) {
...
function RolesComponent_small_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 63);
...
var RolesComponent = class _RolesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RolesComponent, selectors: [["app-roles"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 34, vars: 13, consts: [[1, "module-hero"], [1, "hero-left"], [1, "hero-icon", "indigo"], [1, "pi", "pi-id-card"], [1, "hero-title"], [1, "hero-subtitle"], [1, "hero-badge"], [1, "hero-right"], ["label", "Add Role", "icon", "pi pi-plus", 3, "click"], [2, "display", "grid", "grid-template-columns", "280px 1fr", "gap", "20px"], [1, "table-card", 2, "padding", "0", "overflow", "hidden"], [2, "padding", "12px 16px", "background", "#F8FAFC", "border-bottom", "1px solid #E5E7EB", "font-size", "0.78rem", "font-weight", "700", "text-transform", "uppercase", "letter-spacing", "0.06em", "color", "#6B7280"], ["class", "role-item", 3, "active", "click", 4, "ngFor", "ngForOf"], ["style", "padding:32px;text-align:center;color:#9CA3AF", 4, "ngIf"], ["class", "table-card", 4, "ngIf"], ["class", "table-card", "style", "display:flex;align-items:center;justify-content:center;min-height:220px", 4, "ngIf"], ["position", "right", 3, "visibleChange", "visible", "dismissible"], ["pTemplate", "header"], [3, "ngSubmit", "formGroup"], [1, "field", 2, "margin-bottom", "18px"], [1, "required"], ["pInputText", "", "formControlName", "name", "placeholder", "e.g. Coordinator", 2, "width", "100%"], ["class", "p-error", 4, "ngIf"], [1, "field"], ["pInputText", "", "formControlName", "code", "placeholder", "e.g. COORD", 2, "width", "100%", "text-transform", "uppercase"], [1, "role-item", 3, "click"], [1, "role-name"], [1, "role-code"], [2, "padding", "32px", "text-align", "center", "color", "#9CA3AF"], [1, "pi", "pi-id-card", 2, "font-size", "1.5rem", "display", "block", "margin-bottom", "8px"], [1, "table-card"], [2, "padding", "16px 20px", "border-bottom", "1px solid #F3F4F6", "display", "flex", "justify-content", "space-between", "align-items", "center"], [2, "font-weight", "700", "color", "#1F2937", "font-size", "1rem"], [2, "font-size", "0.82rem", "color", "#6B7280", "margin-top", "2px"], ["style", "margin-left:8px;background:#FEF3C7;color:#92400E;border-radius:4px;padding:2px 8px;font-size:0.72rem;font-weight:700", 4, "ngIf"], ["style", "display:flex;gap:8px", 4, "ngIf"], ["style", "font-size:0.82rem;color:#9CA3AF;display:flex;align-items:center;gap:5px", 4, "ngIf"], [2, "width", "100%", "border-collapse", "collapse"], [2, "background", "#F8FAFC"], [2, "padding", "12px 16px", "text-align", "left", "font-size", "0.78rem", "font-weight", "700", "text-transform", "uppercase", "letter-spacing", "0.05em", "color", "#6B7280", "border-bottom", "2px solid #E5E7EB"], ["style", "width:110px;padding:12px 8px;border-bottom:2px solid #E5E7EB", 4, "ngFor", "ngForOf"], ["class", "perm-row", 3, "background", 4, "ngFor", "ngForOf"], ["style", "padding:14px 20px;border-top:1px solid #F3F4F6;background:#F8FAFC;display:flex;justify-content:flex-end;gap:8px", 4, "ngIf"], [2, "margin-left", "8px", "background", "#FEF3C7", "color", "#92400E", "border-radius", "4px", "padding", "2px 8px", "font-size", "0.72rem", "font-weight", "700"], [2, "display", "flex", "gap", "8px"], ["label", "Cancel", "size", "small", 3, "click", "outlined"], ["label", "Save Permissions", "icon", "pi pi-save", "size", "small", 3, "click", "loading"], [2, "font-size", "0.82rem", "color", "#9CA3AF", "display", "flex", "align-items", "center", "gap", "5px"], [1, "pi", "pi-check-circle", 2, "color", "#10B981"], [2, "width", "110px", "padding", "12px 8px", "border-bottom", "2px solid #E5E7EB"], [1, "col-header"], [3, "ngModelChange", "ngModel", "binary"], [1, "perm-row"], [2, "font-weight", "500", "text-transform", "capitalize", "color", "#374151"], ["class", "perm-check", 4, "ngFor", "ngForOf"], [1, "perm-check"], [2, "padding", "14px 20px", "border-top", "1px solid #F3F4F6", "background", "#F8FAFC", "display", "flex", "justify-content", "flex-end", "gap", "8px"], [1, "table-card", 2, "display", "flex", "align-items", "center", "justify-content", "center", "min-height", "220px"], [2, "text-align", "center", "color", "#9CA3AF"], [1, "pi", "pi-arrow-left", 2, "font-size", "1.5rem", "display", "block", "margin-bottom", "10px"], [2, "display", "flex", "justify-content", "space-between", "align-items", "center", "flex", "1", "margin-right", "8px"], [2, "font-weight", "700", "font-size", "1rem", "color", "#1F2937"], ["label", "Create", "size", "small", 3, "click", "loading"], [1, "p-error"]], template: function RolesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function RolesComponent_Template_p_button_click_12_listener() {
        return ctx.openForm();
      });
      \u0275\u0275elementEnd()()();
      ...
      \u0275\u0275text(16, " All Roles ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(17, RolesComponent_div_17_Template, 5, 4, "div", 12)(18, RolesComponent_div_18_Template, 3, 0, "div", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275template(19, RolesComponent_div_19_Template, 19, 7, "div", 14)(20, RolesComponent_div_20_Template, 4, 0, "div", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "p-sidebar", 16);
      \u0275\u0275twoWayListener("visibleChange", function RolesComponent_Template_p_sidebar_visibleChange_21_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.showForm, $event) || (ctx.showForm = $event);
        return $event;
      });
      \u0275\u0275template(22, RolesComponent_ng_template_22_Template, 6, 2, "ng-template", 17);
      \u0275\u0275elementStart(23, "form", 18);
      \u0275\u0275listener("ngSubmit", function RolesComponent_Template_form_ngSubmit_23_listener() {
        return ctx.saveRole();
      });
      ...
      \u0275\u0275template(28, RolesComponent_small_28_Template, 2, 0, "small", 22);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "div", 23)(30, "label", 20);
      \u0275\u0275text(31, "Code");
      \u0275\u0275elementEnd();
      \u0275\u0275element(32, "input", 24);
      \u0275\u0275template(33, RolesComponent_small_33_Template, 2, 0, "small", 22);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_9_0;
...
//# sourceMappingURL=chunk-E77QSCBP.js.map
