...
function PublicQuizComponent_div_4_p_7_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicQuizComponent_div_4_div_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicQuizComponent_div_4_span_13_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicQuizComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, PublicQuizComponent_div_4_p_7_Template, 2, 1, "p", 18)(8, PublicQuizComponent_div_4_div_8_Template, 6, 1, "div", 19);
    \u0275\u0275elementStart(9, "div", 20)(10, "span");
    \u0275\u0275element(11, "i", 21);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, PublicQuizComponent_div_4_span_13_Template, 4, 5, "span", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 23)(15, "p-button", 24);
    \u0275\u0275listener("click", function PublicQuizComponent_div_4_Template_p_button_click_15_listener() {
      \u0275\u0275restoreView(_r1);
...
function PublicQuizComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "div", 30)(2, "div", 31);
    \u0275\u0275element(3, "i", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h2");
    ...
    \u0275\u0275listener("click", function PublicQuizComponent_div_5_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function PublicQuizComponent_div_5_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PublicQuizComponent_div_6_small_14_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicQuizComponent_div_6_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 53);
    \u0275\u0275element(1, "i", 54);
    \u0275\u0275elementStart(2, "div")(3, "div", 55);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
...
function PublicQuizComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 17)(9, "form", 42);
    \u0275\u0275listener("ngSubmit", function PublicQuizComponent_div_6_Template_form_ngSubmit_9_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(14, PublicQuizComponent_div_6_small_14_Template, 2, 0, "small", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "p-button", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, PublicQuizComponent_div_6_div_16_Template, 7, 3, "div", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 49)(18, "p-button", 50);
    \u0275\u0275listener("click", function PublicQuizComponent_div_6_Template_p_button_click_18_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.step.set("select-type"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "p-button", 51);
    \u0275\u0275listener("click", function PublicQuizComponent_div_6_Template_p_button_click_19_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PublicQuizComponent_div_7_small_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 52);
...
function PublicQuizComponent_div_7_small_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 52);
...
function PublicQuizComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 17)(9, "form", 42);
    \u0275\u0275listener("ngSubmit", function PublicQuizComponent_div_7_Template_form_ngSubmit_9_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(12, "Full Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "input", 58);
    \u0275\u0275template(14, PublicQuizComponent_div_7_small_14_Template, 2, 0, "small", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 59)(16, "label", 44);
    \u0275\u0275text(17, "Gender");
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "p-dropdown", 60);
    \u0275\u0275template(19, PublicQuizComponent_div_7_small_19_Template, 2, 0, "small", 46);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 49)(21, "p-button", 50);
    \u0275\u0275listener("click", function PublicQuizComponent_div_7_Template_p_button_click_21_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.step.set("select-type"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "p-button", 61);
    \u0275\u0275listener("click", function PublicQuizComponent_div_7_Template_p_button_click_22_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.startAsExternal());
    });
...
function PublicQuizComponent_div_8_div_7_div_6_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 81);
    \u0275\u0275listener("click", function PublicQuizComponent_div_8_div_7_div_6_button_1_Template_button_click_0_listener() {
      const key_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const q_r9 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.selectAnswer(q_r9.id, key_r8));
    });
    \u0275\u0275elementStart(1, "span", 82);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const q_r9 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275styleProp("display", ctx_r1.optionText(q_r9, key_r8) ? "" : "none");
    \u0275\u0275classProp("selected", ctx_r1.answers[q_r9.id] === key_r8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(key_r8.toUpperCase());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.optionText(q_r9, key_r8));
  }
}
function PublicQuizComponent_div_8_div_7_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 79);
    \u0275\u0275template(1, PublicQuizComponent_div_8_div_7_div_6_button_1_Template, 5, 6, "button", 80);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function PublicQuizComponent_div_8_div_7_div_7_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 81);
    \u0275\u0275listener("click", function PublicQuizComponent_div_8_div_7_div_7_button_1_Template_button_click_0_listener() {
      const opt_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const q_r9 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.selectAnswer(q_r9.id, opt_r11.value));
    });
    \u0275\u0275elementStart(1, "span", 82);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const oi_r12 = ctx.index;
    const q_r9 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("selected", ctx_r1.answers[q_r9.id] === opt_r11.value);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(oi_r12 + 1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(opt_r11.label);
  }
}
function PublicQuizComponent_div_8_div_7_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 79);
    \u0275\u0275template(1, PublicQuizComponent_div_8_div_7_div_7_button_1_Template, 5, 4, "button", 84);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const q_r9 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.getSelectOptions(q_r9));
  }
}
function PublicQuizComponent_div_8_div_7_div_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 85)(1, "p-dropdown", 86);
    \u0275\u0275listener("ngModelChange", function PublicQuizComponent_div_8_div_7_div_8_Template_p_dropdown_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      const q_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setAnswer(q_r9.id, $event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("options", ctx_r1.getSelectOptions(q_r9))("ngModel", ctx_r1.getAnswer(q_r9.id));
  }
}
function PublicQuizComponent_div_8_div_7_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 87)(1, "input", 88);
    \u0275\u0275listener("input", function PublicQuizComponent_div_8_div_7_div_9_Template_input_input_1_listener($event) {
      \u0275\u0275restoreView(_r14);
      const q_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setAnswer(q_r9.id, $event.target.value));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.getAnswer(q_r9.id));
  }
}
function PublicQuizComponent_div_8_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, PublicQuizComponent_div_8_div_7_div_6_Template, 2, 2, "div", 76)(7, PublicQuizComponent_div_8_div_7_div_7_Template, 2, 1, "div", 76)(8, PublicQuizComponent_div_8_div_7_div_8_Template, 2, 2, "div", 77)(9, PublicQuizComponent_div_8_div_7_div_9_Template, 2, 1, "div", 78);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275classProp("answered", ctx_r1.isAnswered(q_r9.id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Q", i_r15 + 1, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(q_r9.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !q_r9.question_type || q_r9.question_type === "mcq");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r9.question_type === "radio");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r9.question_type === "select");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", q_r9.question_type === "input");
  }
}
function PublicQuizComponent_div_8_span_16_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicQuizComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, PublicQuizComponent_div_8_div_7_Template, 10, 8, "div", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 68)(9, "div", 69)(10, "strong");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " of ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(15, " answered ");
    \u0275\u0275template(16, PublicQuizComponent_div_8_span_16_Template, 2, 1, "span", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "p-button", 71);
    \u0275\u0275listener("click", function PublicQuizComponent_div_8_Template_p_button_click_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PublicQuizComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 94)(6, "span", 95);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 97)(12, "div", 98)(13, "div", 99);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 100);
    \u0275\u0275text(16, "Total");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 98)(18, "div", 99);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 100);
    \u0275\u0275text(21, "Attempted");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 101)(23, "div", 99);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 100);
    \u0275\u0275text(26, "Correct");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 102)(28, "div", 99);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 100);
    \u0275\u0275text(31, "Wrong");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "p", 103);
...
var PublicQuizComponent = class _PublicQuizComponent {
  ...
  startAsRegistered() {
    ...
    this.api.publicPost(`quiz/${slug}/start`, {
      ...
      error: (err) => {
        this.toast.error(err.error?.message || "Could not start quiz");
        this.validating = false;
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PublicQuizComponent, selectors: [["app-public-quiz"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 9, consts: [[1, "quiz-page"], ["class", "quiz-center", 4, "ngIf"], ["class", "quiz-card", 4, "ngIf"], ["class", "quiz-attempt", 4, "ngIf"], ["class", "quiz-card result-card", 4, "ngIf"], ["position", "bottom-right"], [1, "quiz-center"], [1, "pi", "pi-spin", "pi-spinner", 2, "font-size", "2.5rem", "color", "#BE123C"], [2, "margin-top", "12px", "color", "#6B7280"], [1, "pi", "pi-question-circle", 2, "font-size", "3.5rem", "color", "#D1D5DB", "display", "block", "margin-bottom", "16px"], [2, "color", "#374151", "margin", "0 0 8px"], [2, "color", "#9CA3AF"], [1, "pi", "pi-lock", 2, "font-size", "3.5rem", "color", "#D1D5DB", "display", "block", "margin-bottom", "16px"], [1, "quiz-card"], [1, "quiz-header"], [1, "quiz-icon"], [1, "pi", "pi-question-circle"], [1, "quiz-body"], ["class", "quiz-desc", 4, "ngIf"], ["class", "quiz-instructions", 4, "ngIf"], [1, "quiz-meta"], [1, "pi", "pi-list"], [4, "ngIf"], [1, "quiz-footer"], ["label", "Start Quiz", "icon", "pi pi-play", "styleClass", "btn-start", 3, "click"], [1, "quiz-desc"], [1, "quiz-instructions"], [1, "instr-label"], [1, "pi", "pi-info-circle"], [1, "pi", "pi-calendar"], [1, "quiz-header", "small"], [1, "quiz-icon", "small"], [1, "pi", "pi-users"], [1, "type-grid"], [1, "type-card", 3, "click"], [1, "pi", "pi-id-card", 2, "font-size", "2rem", "color", "#BE123C", "margin-bottom", "12px"], [1, "type-title"], [1, "type-desc"], [1, "type-arrow"], [1, "pi", "pi-arrow-right"], [1, "pi", "pi-user-plus", 2, "font-size", "2rem", "color", "#059669", "margin-bottom", "12px"], [1, "pi", "pi-id-card"], [3, "ngSubmit", "formGroup"], [1, "field", 2, "margin-bottom", "16px"], [1, "req"], ["pInputText", "", "formControlName", "yuvak_id", "placeholder", "e.g. YUVAKAHM000001", 2, "width", "100%", "text-transform", "uppercase", 3, "ngClass"], ["class", "p-error", 4, "ngIf"], ["type", "submit", "label", "Validate ID", "icon", "pi pi-search", "styleClass", "w-full", 3, "loading"], ["class", "yuvak-found", 4, "ngIf"], [1, "quiz-footer", 2, "justify-content", "space-between"], ["label", "Back", "icon", "pi pi-arrow-left", 3, "click", "outlined"], ["label", "Start Quiz", "icon", "pi pi-play", 3, "click", "disabled", "loading"], [1, "p-error"], [1, "yuvak-found"], [1, "pi", "pi-check-circle", 2, "color", "#10B981", "font-size", "1.4rem"], [2, "font-weight", "700", "color", "#1F2937"], [2, "font-size", "0.82rem", "color", "#6B7280"], [1, "pi", "pi-user-plus"], ["pInputText", "", "formControlName", "name", "placeholder", "Enter your full name", 2, "width", "100%", 3, "ngClass"], [1, "field", 2, "margin-bottom", "20px"], ["formControlName", "gender", "optionLabel", "label", "optionValue", "value", "placeholder", "Select gender", "styleClass", "w-full", 3, "options"], ["label", "Start Quiz", "icon", "pi pi-play", 3, "click", "loading"], [1, "quiz-attempt"], [1, "attempt-header"], [1, "attempt-title"], [1, "attempt-progress"], [1, "question-list"], ["class", "q-block", 4, "ngFor", "ngForOf"], [1, "submit-bar"], [1, "submit-info"], ["style", "color:#D97706;margin-left:8px", 4, "ngIf"], ["label", "Submit Quiz", "icon", "pi pi-send", "styleClass", "btn-submit", 3, "click", "loading"], [1, "q-block"], [1, "q-num-row"], [1, "q-num-tag"], [1, "q-text"], ["class", "options-grid", 4, "ngIf"], ["class", "select-wrap", 4, "ngIf"], ["class", "input-wrap", 4, "ngIf"], [1, "options-grid"], ["class", "opt-btn", 3, "selected", "display", "click", 4, "ngFor", "ngForOf"], [1, "opt-btn", 3, "click"], [1, "opt-key"], [1, "opt-text"], ["class", "opt-btn", 3, "selected", "click", 4, "ngFor", "ngForOf"], [1, "select-wrap"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Choose your answer\u2026", "styleClass", "w-full", 3, "ngModelChange", "options", "ngModel"], [1, "input-wrap"], ["pInputText", "", "placeholder", "Type your answer here\u2026", 2, "width", "100%", 3, "input", "value"], [2, "color", "#D97706", "margin-left", "8px"], [1, "quiz-card", "result-card"], [1, "result-icon"], [1, "pi"], [1, "result-title"], [1, "result-score"], [1, "big-score"], [1, "score-label"], [1, "result-stats"], [1, "stat-box"], [1, "stat-v"], [1, "stat-l"], [1, "stat-box", "correct"], [1, "stat-box", "wrong"], [2, "text-align", "center", "color", "#9CA3AF", "font-size", "0.88rem", "margin-top", "20px"]], template: function PublicQuizComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, PublicQuizComponent_div_1_Template, 4, 0, "div", 1)(2, PublicQuizComponent_div_2_Template, 6, 0, "div", 1)(3, PublicQuizComponent_div_3_Template, 6, 0, "div", 1)(4, PublicQuizComponent_div_4_Template, 16, 5, "div", 2)(5, PublicQuizComponent_div_5_Template, 25, 0, "div", 2)(6, PublicQuizComponent_div_6_Template, 20, 10, "div", 2)(7, PublicQuizComponent_div_7_Template, 23, 9, "div", 2)(8, PublicQuizComponent_div_8_Template, 18, 8, "div", 3)(9, PublicQuizComponent_div_9_Template, 34, 19, "div", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275element(10, "p-toast", 5);
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-V3AJACJE.js.map
