...
var routes = [
  ...
  {
    path: "admin/login",
    loadComponent: () => import("./chunk-UN6N73QR.js").then((m) => m.LoginComponent)
  },
  {
    path: "admin/forgot-password",
    loadComponent: () => import("./chunk-R7BQ7ORD.js").then((m) => m.ForgotPasswordComponent)
  },
  {
    path: "admin/reset-password",
    loadComponent: () => import("./chunk-AK7WPTKS.js").then((m) => m.ResetPasswordComponent)
  },
  // Admin (protected)
  {
    path: "admin",
    loadComponent: () => import("./chunk-D2WSFP3C.js").then((m) => m.LayoutComponent),
    canActivate: [authGuard],
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-HOWK4QEN.js").then((m) => m.DashboardComponent) },
      // Yuvak
      { path: "yuvak", loadComponent: () => import("./chunk-JHXRWB4Q.js").then((m) => m.YuvakListComponent) },
      { path: "yuvak/new", loadComponent: () => import("./chunk-JEPCE5GQ.js").then((m) => m.YuvakFormComponent) },
      { path: "yuvak/:id", loadComponent: () => import("./chunk-JEPCE5GQ.js").then((m) => m.YuvakFormComponent) },
      // Yuvati
      { path: "yuvati", loadComponent: () => import("./chunk-YF2HQX4N.js").then((m) => m.YuvatiListComponent) },
      { path: "yuvati/new", loadComponent: () => import("./chunk-42NG4UIL.js").then((m) => m.YuvatiFormComponent) },
      { path: "yuvati/:id", loadComponent: () => import("./chunk-42NG4UIL.js").then((m) => m.YuvatiFormComponent) },
      // Org
      { path: "xetra", loadComponent: () => import("./chunk-AEBJ2KO4.js").then((m) => m.XetraComponent) },
      { path: "mandal", loadComponent: () => import("./chunk-37ZFNR6P.js").then((m) => m.MandalComponent) },
      // Users & Roles
      { path: "users", loadComponent: () => import("./chunk-4W6B3ESD.js").then((m) => m.UsersComponent) },
      { path: "roles", loadComponent: () => import("./chunk-LAGLFENT.js").then((m) => m.RolesComponent) },
      // Shibir & Attendance
      { path: "shibir", loadComponent: () => import("./chunk-VIDECGLX.js").then((m) => m.ShibirComponent) },
      { path: "attendance", loadComponent: () => import("./chunk-7KWDD2QN.js").then((m) => m.AttendanceComponent) },
      // Quiz
      { path: "quiz", loadComponent: () => import("./chunk-VIMLP26F.js").then((m) => m.QuizListComponent) },
      { path: "quiz/new", loadComponent: () => import("./chunk-JPXA3X3D.js").then((m) => m.QuizFormComponent) },
      { path: "quiz/:id", loadComponent: () => import("./chunk-JPXA3X3D.js").then((m) => m.QuizFormComponent) },
      { path: "quiz/:id/questions", loadComponent: () => import("./chunk-6HEPLUUE.js").then((m) => m.QuizQuestionsComponent) },
      // Settings
      { path: "settings", loadComponent: () => import("./chunk-F4N7JH7P.js").then((m) => m.SettingsComponent) },
      // Reports
      { path: "reports", loadComponent: () => import("./chunk-5DYMWECO.js").then((m) => m.ReportsComponent) }
    ]
  },
  // Public pages
  {
    path: "register/:type",
    loadComponent: () => import("./chunk-DB7O3OQ4.js").then((m) => m.RegisterComponent)
  },
  {
    path: "quiz/:slug",
    loadComponent: () => import("./chunk-V3AJACJE.js").then((m) => m.PublicQuizComponent)
  },
  {
    path: "welcome/:type/:uuid",
    loadComponent: () => import("./chunk-J77GRSF2.js").then((m) => m.WelcomeComponent)
  },
