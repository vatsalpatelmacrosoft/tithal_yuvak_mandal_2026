...
function WelcomeComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(32, "qrcode", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 23);
    \u0275\u0275text(34, "Show this QR code at the gate for attendance");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 24)(36, "button", 25);
    \u0275\u0275listener("click", function WelcomeComponent_div_1_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.copyWelcomeUrl());
    });
    \u0275\u0275element(37, "i", 26);
    \u0275\u0275elementStart(38, "span");
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(40, "div", 27)(41, "span");
    \u0275\u0275text(42, "Save this page or screenshot for future reference");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(ctx_r1.member().full_name);
    \u0275\u0275advance();
    \u0275\u0275classProp("yuvak", ctx_r1.member().type === "yuvak")("yuvati", ctx_r1.member().type === "yuvati");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.member().type === "yuvak" ? "Yuvak ID" : "Yuvati ID");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.member().member_id);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.member().xetra_name);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.member().mandal_name);
    \u0275\u0275advance(5);
    \u0275\u0275property("qrdata", ctx_r1.qrData)("width", 200)("errorCorrectionLevel", "M")("colorDark", "#111827")("colorLight", "#ffffff")("margin", 2);
    \u0275\u0275advance(5);
    \u0275\u0275styleProp("color", ctx_r1.copied ? "#10B981" : "#f97316");
    \u0275\u0275classProp("pi-copy", !ctx_r1.copied)("pi-check", ctx_r1.copied);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.copied ? "Copied Link!" : "Copy Welcome Link");
  }
}
...
var WelcomeComponent = class _WelcomeComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WelcomeComponent, selectors: [["app-welcome"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 4, vars: 3, consts: [[1, "welcome-page"], ["class", "welcome-card", 4, "ngIf"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], [1, "welcome-card"], [1, "welcome-header"], [1, "welcome-logo"], ["src", "assets/Baps_logo.svg.png", "alt", "BAPS Logo", 1, "welcome-logo-img"], [1, "org-name"], [1, "org-sub"], [1, "welcome-body"], [1, "greeting"], [1, "member-name"], [1, "id-badge"], [1, "id-label"], [1, "id-value"], [1, "info-row"], [1, "info-label"], [1, "info-value"], [1, "qr-section"], [1, "qr-title"], [1, "qr-wrapper"], ["cssClass", "qr-canvas", 3, "qrdata", "width", "errorCorrectionLevel", "colorDark", "colorLight", "margin"], [1, "qr-hint"], [1, "copy-url-section", 2, "margin-top", "16px", "text-align", "center"], [1, "copy-btn", 2, "background", "white", "border", "1px solid #e5e7eb", "border-radius", "20px", "padding", "8px 16px", "font-size", "0.85rem", "font-weight", "500", "cursor", "pointer", "display", "inline-flex", "align-items", "center", "gap", "8px", "color", "#374151", "box-shadow", "0 1px 2px rgba(0,0,0,0.05)", "transition", "all 0.2s", 3, "click"], [1, "pi", 2, "font-size", "0.95rem"], [1, "welcome-footer"], [1, "loading-state"], [1, "spinner"], [1, "error-state"], [1, "error-icon"]], template: function WelcomeComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, WelcomeComponent_div_1_Template, 43, 22, "div", 1)(2, WelcomeComponent_div_2_Template, 4, 0, "div", 2)(3, WelcomeComponent_div_3_Template, 5, 1, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-O3UZUNSS.js.map
