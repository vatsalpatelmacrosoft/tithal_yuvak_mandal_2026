...
var YuvatiFormComponent = class _YuvatiFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _YuvatiFormComponent, selectors: [["app-yuvati-form"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 87, vars: 31, consts: [[1, "back-link", 3, "click"], [1, "pi", "pi-arrow-left"], [1, "form-hero", "yuvati-hero"], [1, "form-hero-left"], [1, "form-hero-icon"], [1, "pi", "pi-users"], [1, "form-hero-title"], [1, "form-hero-sub"], [1, "form-hero-actions"], ["label", "Cancel", 3, "click", "outlined"], ["icon", "pi pi-save", 3, "click", "label", "loading"], [3, "ngSubmit", "formGroup"], [1, "form-section"], [1, "section-title"], [1, "pi", "pi-user"], [1, "form-row"], [1, "field"], [1, "req"], ["pInputText", "", "formControlName", "first_name", "placeholder", "First name"], ["class", "p-error", 4, "ngIf"], ["pInputText", "", "formControlName", "middle_name", "placeholder", "Optional"], ["pInputText", "", "formControlName", "last_name", "placeholder", "Last name"], [1, "pi", "pi-phone"], ["pInputText", "", "formControlName", "mo_number", "type", "tel", "placeholder", "10-digit mobile"], ["pInputText", "", "formControlName", "whatsapp_number", "type", "tel", "placeholder", "If different from mobile"], ["pInputText", "", "formControlName", "email", "type", "email", "placeholder", "Email (optional)"], [1, "pi", "pi-map"], ["formControlName", "xetra_id", "optionLabel", "name", "optionValue", "id", "placeholder", "Select Xetra", 3, "options", "ngClass"], ["formControlName", "mandal_id", "optionLabel", "name", "optionValue", "id", 3, "options", "placeholder", "disabled", "ngClass"], ["formControlName", "is_karyakar", "optionLabel", "label", "optionValue", "value", 3, "options"], [1, "pi", "pi-info-circle"], [1, "field", 2, "margin-bottom", "16px"], ["pInputTextarea", "", "formControlName", "address", "placeholder", "Full residential address", "rows", "3"], ["formControlName", "tags", "placeholder", "Add tag and press Enter"], [1, "form-hero-actions", 2, "justify-content", "flex-end", "margin-bottom", "8px"], ["type", "button", "label", "Cancel", 3, "click", "outlined"], ["type", "submit", "icon", "pi pi-save", 3, "label", "loading"], [1, "p-error"]], template: function YuvatiFormComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(17);
      \u0275\u0275property("options", ctx.xetras)("ngClass", \u0275\u0275pureFunction1(27, _c0, ctx.hasErr("xetra_id")));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.hasErr("xetra_id"));
      \u0275\u0275advance(4);
      \u0275\u0275property("options", ctx.mandals)("placeholder", ctx.loadingMandals ? "Loading..." : !((tmp_16_0 = ctx.form.get("xetra_id")) == null ? null : tmp_16_0.value) ? "Select Xetra first" : "Select Mandal")("disabled", !((tmp_17_0 = ctx.form.get("xetra_id")) == null ? null : tmp_17_0.value) || ctx.loadingMandals)("ngClass", \u0275\u0275pureFunction1(29, _c0, ctx.hasErr("mandal_id")));
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-PNLUSRC2.js.map
