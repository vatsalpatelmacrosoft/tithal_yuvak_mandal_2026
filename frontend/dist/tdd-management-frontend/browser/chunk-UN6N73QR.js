...
var LoginComponent = class _LoginComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 10, consts: [[1, "login-bg"], [1, "login-card"], [1, "brand-top"], [1, "logo-ring"], [1, "divider-line"], [3, "ngSubmit", "formGroup"], [1, "field"], [1, "form-label"], [1, "input-icon-wrap"], [1, "pi", "pi-mobile", "field-icon"], ["pInputText", "", "formControlName", "mo_number", "type", "tel", "placeholder", "10-digit mobile number"], ["class", "p-error", 4, "ngIf"], [1, "lc-pw"], ["formControlName", "password", "placeholder", "Enter your password", "inputStyleClass", "w-full", 3, "feedback", "toggleMask"], [1, "btn-wrap"], ["type", "submit", "label", "Sign In", "icon", "pi pi-sign-in", 3, "loading"], [1, "forgot-link"], ["routerLink", "/admin/forgot-password"], [1, "footer-note"], ["position", "bottom-right"], [1, "p-error"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(17, LoginComponent_small_17_Template, 2, 0, "small", 11);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, LoginComponent_small_23_Template, 2, 0, "small", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "span", 14);
      \u0275\u0275element(25, "p-button", 15);
      \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-UN6N73QR.js.map
